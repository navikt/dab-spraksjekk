...
import { Kansellisten } from '../analysis/dictionaries';
                ...
                <Accordion.Item>
                    <Accordion.Header>
                        {kansellistenResultater.length == 1 ? (
                            <>1 ord som kan byttes ut</>
                        ) : (
                            <>{kansellistenResultater.length} ord som kan byttes ut</>
                        )}
                    </Accordion.Header>
                    <Accordion.Content>
                        ...
                        <div className="språkhjelp-pb-6">
                            Ord og uttrykk som er utdaterte eller sier noe på en vanskeligere måte enn nødvendig:
                        </div>
                        {kansellistenResultater.length >= 1 && (
                            <>
